...
void Parser::init ()
{
	required.emplace("announce", std::forward_list<std::string>{"port","peer_id","left","compact","user-agent","downloaded","uploaded","corrupt"}); // init a set of required params in a request
